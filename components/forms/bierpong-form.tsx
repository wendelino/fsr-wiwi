        ...
        >
            {(form) => (
                <>
                    ...
                    />
                    <p className="text-sm text-muted-foreground">Du musst deine E-Mail nach der Anmeldung bestätigen, um teilzunehmen.
                        Andernfalls wird deine Anmeldung nach 24 Stunden automatisch storniert. </p>
                    <FormField
                        control={form.control}
                        name="dsgvo"
                        render={({ field }) => (
